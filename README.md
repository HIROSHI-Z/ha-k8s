...
##大致环境说明一下;  摘录过来，没有做master高可以，下次上传自己做的测试环境
...
2）首先把192.168.11.122上的keepalived停用，看vip会不会到192.168.11.118上, tcping test
![image](images/4.png)   



---
没有配置成抢占模式，当192.168.11.122业务都恢复正常了之后，VIP是不会到192.168.11.118上面的来
